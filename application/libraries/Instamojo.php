...
class Instamojo
{
    ...
    {
        $this->api_key = $api_key != null ? (string)$api_key : $this->api_key;
        $this->auth_token = $auth_token != null ? (string)$auth_token : $this->auth_token;
        $this->endpoint = $endpoint != null ? (string)$endpoint : $this->endpoint;
    }
